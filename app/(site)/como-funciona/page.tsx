...
const steps = [
  ...
  { t: "3. Análise gratuita", d: "A Fluxo Prime analisa o sacado, o título, o risco de crédito, a validade documental, duplicidade, fraude e histórico — sem custo." },
  ...
  { t: "6. Cobrança e gestão", d: "A Fluxo Prime cuida da cobrança, acompanhamento, notificação e relatórios da carteira." },
];
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Um fluxo operacional transparente, do envio do título à cobrança — com análise gratuita do sacado e contratos claros."
      />
